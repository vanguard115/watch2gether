...
export default {
    ...
    methods: {
        getTheMovieDB (searchQuery) {
            ...
            const reqURL = "https://api.themoviedb.org/3/search/movie?api_key=6042734eb2d75c2d6f32707cd3cc129c&language=en-US&page=1&include_adult=true&query=" +  searchQuery
            console.log(reqURL)
